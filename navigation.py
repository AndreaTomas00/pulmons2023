...
def make_sidebar():
    with st.sidebar:
        ...
        if st.session_state.get("logged_in", False):
            st.page_link("pages/01_Ofertes.py", label="Global ofertes",)
            ...
            st.page_link("pages/05_Motius_rebuig.py", label="Motius rebuig")
            st.page_link("pages/06_Evolutiu.py", label="Evolutiu")
